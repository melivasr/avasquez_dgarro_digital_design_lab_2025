module ram2vga_bridge (
    ...
    typedef enum logic [2:0] {R_P1Y, R_P2Y, R_BX, R_BY, R_S1, R_S2} vga_read_state_t;
    ...
    always_ff @(posedge clk or posedge reset) begin
        if (reset) begin
            ...
            // q_b es la palabra leída con la address_b del ciclo anterior
            case (state)
                R_P1Y: begin
                    paddle1_y_reg <= q_b;   
                    addr_b <= 3'd1; // P2_Y
